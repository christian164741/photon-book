...
\begin{itemize}
	...
	\begin{tcolorbox}[hinweisbox, title=Reales Bildmaterial]
		...
		Ein reales Foto des entfalteten Sonnensegels der Raumsonde IKAROS wurde 2010 von der Mini-Kamera DCAM2 aufgenommen.  
...
\subsubsection{Zusammenfassung -- Ionisierende und  \newline Nicht-ionisierende Strahlung}
\vspace{1em}
...
\begin{itemize}
	...
	\item Die Geschwindigkeit hienge von der Energie (bzw. Frequenz) ab $\Rightarrow$ Verletzung der Lorentz-Invarianz.
...
\subsubsection*{Experimentelle Grenzen:}
\phantomsection
...
Die Zahl $10^{-54} \text{ kg}$ 	ist kein Naturgesetz und auch kein theoretischer Wert, sondern eine Obergrenze, die sich aus dem Ergebnis vieler Experimente und Beobachtungen ergibt – unter der Annahme, dass das Photon eine Masse haben könnte.
...
\begin{tcolorbox}[hypobox, title={Was wäre wenn, wenn das Photon eine Masse hätte? }]
	...
	\begin{itemize}
		...
		\item wäre die Energie-Frequenz-Beziehung nicht mehr $E = hf$, sondern würde der relativistischen Energie-Impuls-Beziehung folgen:
		\begin{equation*}
		...
		\item würde sich das Coulomb-Gesetz ändern – elektrischer Felder hätten nur noch eine endliche Reichweite.
	\end{itemize}
...
\begin{tcolorbox}[physikbox, title=Fazit: Warum das Photon masselos ist]
	\begin{itemize}
		...
		\item W\"are $m_\gamma > 0$, w\"urde das gegen viele Beobachtungen und die spezielle Relativit\"at verstößen.
	\end{itemize}
\end{tcolorbox}
\vspace{1em}
\newpage
...
\subsubsection{Polarisation als makroskopische \newline Erscheinung des Spins}
