...
%Kapitel II
%\section{Kapitel II}
\section{Herleitung des Rayleigh-Jeans\newline-Gesetzes}\index{Rayleigh-Jeans-Gesetz!Herleitung}\index{Rayleigh, Lord}\index{Jeans, James}\index{Ultraviolett-Katastrophe}
...
\section{Herleitung des Planckschen Strahl-\newline ungsgesetzes}\index{Plancksches Strahlungsgesetz!Herleitung}\index{Planck, Max}
...
Wir können in zwei Wegen begründen, warum ein einzelnes Lichtquant (Photon) die Energie
\[
E = h\nu = \hbar \omega
\]
trägt.
...
\phantomsection
\begin{itemize}
	\item Die Photonenenergie hängt \emph{nur} von der Frequenz ab (nicht von der Intensität\index{Intensität}). 
	\item In Verbindung mit \(E_{\text{kin}}=h\nu-A\) erklärt dies die Grenzfrequenz\index{Grenzfrequenz} beim Photoeffekt. 
	\item Zusammen mit der Feldquantisierung führt dies zu Teilchenzahloperator \(\hat N=\hat a^\dagger \hat a\)\index{Teilchenzahloperator} und einer klaren Zuweisung der Energie pro Photon.
\end{itemize}
...
\section{Hong--Ou--Mandel-Interferenz am \newline Strahlteiler}
\label{anhangA:HOM}
...
%\section{Kapitel V}
\section{Feldformalismus und Viererpoten- \newline tial}
