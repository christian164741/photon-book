...
\begin{itemize}
	\item Spontaneous parametric down-conversion (SPDC) in nonlinear crystals.
	\item Single atoms or ions in optical traps\index{Optical trap}.
	\item Quantum dots in semiconductors.
\end{itemize}
...
\subsection{Graviton, Dark Energy, New Physics?}
\index{New physics}
