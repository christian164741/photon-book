...
\begin{itemize}
	\item exceed a clear threshold (threshold detection\index{Threshold detection}),
	\item be temporally well separated (observe dead time\index{Dead time}),
	\item and not be confused with thermal noise\index{Thermal noise} or dark current\index{Dark current}.
\end{itemize}
\vspace{1em}
